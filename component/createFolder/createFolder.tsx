  ...
  return (
    <div className="min-h-screen  bg-white dark:bg-black   flex justify-center items-center py-[15px]">
      <div className="w-[560px]  ">
        ...
        {/* Folder Name Input */}
        <div className='p-[25px] border-1 border-[#D1D5DB] rounded-md'>
          <div className="mb-6  ">
        ...
        {/* Description Input */}
        <div className="mb-2">
          <label className="block text-sm font-medium text-gray-900 mb-2 dark:text-[#FFFFFF]">
          ...
          <div className="border border-[#D1D5DB] rounded-lg p-[17px] bg-white dark:bg-[#28272A]" >
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  backgroundColor: selectedColor === '#34D399' ? '#D1FAE5' :
