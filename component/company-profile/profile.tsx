...
export default function CompanyProfile() {
  ...
  const getFullLocation = () => {
    if (!company) return 'Location not specified';
  ...
  const getCompanyName = () => {
    if (!company?.name) return 'Company Name Not Set';
    return company.name;
  };
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white dark:bg-black p-[36px] md:px-[80px] flex items-center justify-center">
        <div className="text-gray-600 dark:text-[#FFFFFF]">Loading...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black p-[36px] md:px-[80px]">
      <div className="">
        <h1 className="font-inter font-semibold text-2xl leading-8 text-gray-600 tracking-[-0.5px] mb-[62px] dark:text-[#FFFFFF]">
          Company Profile
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[145px]">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h2 className="text-xl md:text-2xl font-bold text-gray-600 dark:text-[#FFFFFF]">
                  {getCompanyName()}
                </h2>
            ...
            <div className="space-y-4">
              {company?.phone && (
                <div className="flex items-center gap-4 p-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-600 dark:text-[#FFFFFF]">
                ...
                <div className="flex items-center gap-4 p-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-[#FFFFFF]">
                      {company?.postalCode ? `Postal: ${company.postalCode}` : 'Location'}
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="mt-8">
              ...
              {company?.joinedDate && (
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                  Member since: {new Date(company.joinedDate).toLocaleDateString()}
                </p>
              )}
            </div>
          </div>
